...
def render():
    page_header(
        title="IGR Analytics · ANS",
        subtitle="Análise estatística do Índice Geral de Reclamações · Disciplina: Algoritmo II · Autor: Jocimir Aujo",
        icon="🏥",
    )
    ...
    with col2:
        ...
        <div style="background:{THEME['info_bg']}; border-radius:12px; padding:20px; border:1px solid {THEME['border']};">
          ...
          <div style="font-size:14px; margin-bottom:8px;"><b>Autor:</b> Jocimir Aujo</div>
